...

{
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		double timestamp_difference;
		{
...

				{
					...
					while ((sCurrentLine = br.readLine()) != null) {
						...
						if (sCurrentLine.contains(Search)) {
							...
							{
								int i=0;
								String arr[i]=st.nextToken();
							}
							System.out.println(
									"     (addClient:97900) string found in log file where Name of service is = addClient & Request id is = 97900 ");
							break;
						}
...

				{
					...
					while ((sCurrentLine = br1.readLine()) != null) {
						if (sCurrentLine.contains(Search1)) {
							System.out.println(
									" Sr.No 3 - Entry time stamp of Add Client Request (id-97900) found in logfile is = "
											+ Search1);
						}
...

				{
					...
					while ((sCurrentLine = br2.readLine()) != null) {
						if (sCurrentLine.contains(Search2)) {
							System.out.println(
									" Sr.No 4 - Exit time stamp of Add Client Request (id-97900) found in logfile is = "
											+ Search2);
						}
...

				{
					...
					while ((sCurrentLine = br3.readLine()) != null) {
						if (sCurrentLine.contains(Search3)) {
							System.out.println(
									" Sr.No 5 - Entry time stamp (in seconds) of Add Client Request (id-97900) found in logfile is = "
											+ Search3);
...

				{
					...
					while ((sCurrentLine = br4.readLine()) != null) {
						if (sCurrentLine.contains(Search4)) {
							System.out.println(
									" Sr.No 6 - Exit time stamp (in seconds) of Add Client Request (id-97900) found in logfile is = "
											+ Search4);
			...
			System.out.println(" Sr.No 7 - Maximum time required for Add Client request execution ( in seconds ) is = "
